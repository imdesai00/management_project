      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="page-header">
              <h3 class="page-title"> Crop Data </h3>
            </div>
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <form>
                      <a type="button" href="update_crop.php" class="btn btn-gradient-primary btn-icon-text">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Update </a>
                        <a type="button" href="delete_crop.php" class="btn btn-gradient-primary btn-icon-text">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                            <td><?php echo $row_crop['crop_id'];?></td>
                            <td><?php echo $row_crop['crop_name'];?></td>
                        </tr>
                        <?php
                                }
                            ?>
