      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="page-header">
              <h3 class="page-title"> PGR Data </h3>
            </div>
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <form>
                      <a type="button" href="update_pgr.php" class="btn btn-gradient-primary btn-icon-text">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Update </a>
                        <a type="button" href="delete_pgr.php" class="btn btn-gradient-primary btn-icon-text">
                    ...
                    <table class="table">
                      ...
                      <?php
                        ...
                        while($row_pgr=$r_pgr->fetch_assoc())
                            {
                        ?>
                      <tbody>
                        <tr>
                            <td><?php echo $row_pgr['PGR_no'];?></td>
                            <td><?php echo $row_pgr['Name'];?></td>
                            <td><?php echo $row_pgr['Technical'];?></td>
                        </tr>
                        <?php
                                }
                            ?>
