      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="page-header">
              <h3 class="page-title"> Fungicide Data </h3>
            </div>
            <div class="row">
                  ...
                  <form>
                    ...
                    <table class="table">
                      ...
                      <?php
                           ...
                           while($row_fungicide=$r_fungicide->fetch_assoc())
                            {
                        ?>
                      <tbody>
                        <tr>
                            <td><?php echo $row_fungicide['Fungicide_no'];?></td>
                            <td><?php echo $row_fungicide['Name'];?></td>
                            <td><?php echo $row_fungicide['Technical'];?></td>
                        </tr>
                        <?php
                                }
                            ?>
