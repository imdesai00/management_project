          ...
          <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Update Insecticide</h4>
                      <p class="card-description"> change data of perticular spray. </p>
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <form method="POST" action = "<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="Type">
                                ...
                                <?php 
                                    ...
                                    <option value="<?php echo $rows['Insecticide_no'];?>" ><?php echo $rows['Insecticide_no'];?></option>
                                    <?php } ?>
                            </select>
                      ...
                      <form method="POST" action = "php_action/update_insecticide.php">
                        <?php
                            $t1 = $_POST['Type'];
                            $sql = "SELECT * FROM  insecticide where Insecticide_no = '$t1'";
                                    $result1 = mysqli_query($connect, $sql); 
                                    while($rows=mysqli_fetch_assoc($result1)){
                        ?>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  name="Name" value="<?php echo $rows['Name'];?>" placeholder="Enter Name" class="form-control" />
                                </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Technical</label>
                                <div class="col-sm-9">
                                    <input type="text"  name="Technical" value="<?php echo $rows['Technical'];?>" placeholder="Enter Technical" class="form-control" />
                                </div>
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"  name="Quantity" value="<?php echo $rows['Quantity'];?>" placeholder="Enter Quantity" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <input type="hidden" name="Type" value ="<?php echo $rows['Insecticide_no'];?>" placeholder="Enter dayes for reminder" class="form-control" >
                      <?php } ?>
                      <button type="submit" class="btn btn-gradient-primary mb-2">Submit</button>
                    </form>
                  </div>
