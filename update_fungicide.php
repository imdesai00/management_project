          ...
          <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Update Fungicide</h4>
                          ...
                          <form method="POST" action = "<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="Type">
                                ...
                                <?php 
                                    ...
                                    <option value="<?php echo $rows['Fungicide_no '];?>" ><?php echo $rows['Fungicide_no '];?></option>
                                    <?php } ?>
                            </select>
                      ...
                      <form method="POST" action = "php_action/update_fungicide.php">
                        <?php
                            $t1 = $_POST['Type'];
                            $sql = "SELECT * FROM  pgr where Fungicide_no = '$t1'";
                                    $result1 = mysqli_query($connect, $sql); 
                                    while($rows=mysqli_fetch_assoc($result1)){
                        ?>
                        <div class="row">
                      ...
                      <input type="hidden" name="Type" value ="<?php echo $rows['Fungicide_no'];?>" placeholder="Enter dayes for reminder" class="form-control" >
                      <?php } ?>
                      <button type="submit" class="btn btn-gradient-primary mb-2">Submit</button>
                    </form>
                  </div>
