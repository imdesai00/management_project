            ...
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <form>
                      <a type="button" href="update_fertilizer.php" class="btn btn-gradient-primary btn-icon-text">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Update </a>
                        <a type="button" href="delete_fertilizer.php" class="btn btn-gradient-primary btn-icon-text">
                    ...
                    <table class="table">
                      ...
                      <?php
                        ...
                        while($row_fertilizer=$r_fertilizer->fetch_assoc())
                            {
                        ?>
                      <tbody>
                        <tr>
                            <td><?php echo $row_fertilizer['Fertilizer_no'];?></td>
                            <td><?php echo $row_fertilizer['Name'];?></td>
                        </tr>
                        <?php
                                }
                            ?>
