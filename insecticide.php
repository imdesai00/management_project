      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-body">
                <form method="POST" action = "php_action/create_insecticide.php">
                  <h4 class="card-title">Insecticide</h4>
                  <form class="form-sample">
                    <p class="card-description"> Data About Insecticide Spray </p>
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text"  name="Technical" placeholder="Enter Technical" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
