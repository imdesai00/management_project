      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="page-header">
              <h3 class="page-title"> Insecticide Data </h3>
            </div>
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <form>
                      <a type="button" href="update_insecticide.php" class="btn btn-gradient-primary btn-icon-text">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Update </a>
                        <a type="button" href="delete_insecticide.php" class="btn btn-gradient-primary btn-icon-text">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i> Delet</a>
                    </form>
                    <table class="table">
                      <thead>
                        <tr>
                        <th>Insecticide_no</th>
                        <th>Quantity</th>
                        <th>Name</th>
                        <th>Technical</th>
                        </tr>
                      ...
                      <?php
                            ...
                            while($row_insecticide=$r_insecticide->fetch_assoc())
                            {
                        ?>
                      <tbody>
                        <tr>
                        <td><?php echo $row_insecticide['Insecticide_no'];?></td>
                        <td><?php echo $row_insecticide['Quantity'];?></td>
                        <td><?php echo $row_insecticide['Name'];?></td>
                        <td><?php echo $row_insecticide['Technical'];?></td>
                        </tr>
                        <?php
                                }
                            ?>
