...
<div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <form method="POST" action = "php_action/create_sales.php">
			<div class="row">
				<div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-select" aria-label="Default select example" name="Type">
                            ...
                            <?php 
                                $sql = "SELECT type FROM harvesting;";
            ...
            <div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="Broker_Name" placeholder="Enter Broker_Name" class="form-control" required>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>Kgs</label>
						<input type="text" name="Kgs" id="Kgs" placeholder="Enter Kgs" class="form-control" >
					</div>
				</div>
			</div>
            <div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label>Total</label>
						<input type="text" name="Total" id="total" placeholder="Enter Total" class="form-control" >
					</div>
				</div>
			</div>
			<div class="row">
