          ...
          <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Update Crop</h4>
                          ...
                          <form method="POST" action = "<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <select class="form-select" aria-label="Default select example" name="Type">
                                ...
                                <?php 
                                    ...
                                    <option value="<?php echo $rows['crop_id'];?>" ><?php echo $rows['crop_id'];?></option>
                                    <?php } ?>
                            </select>
                      ...
                      <form method="POST" action = "php_action/update_crop.php">
                        <?php
                            $t1 = $_POST['Type'];
                            $sql = "SELECT * FROM  crop where crop_id = '$t1'";
                                    $result1 = mysqli_query($connect, $sql); 
                                    while($rows=mysqli_fetch_assoc($result1)){
                        ?>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  name="Name" value="<?php echo $rows['crop_name'];?>" placeholder="Enter Name" class="form-control" />
                                </div>
                                </div>
                            </div>
                      ...
                      <input type="hidden" name="Type" value ="<?php echo $rows['crop_id'];?>" placeholder="Enter dayes for reminder" class="form-control" >
                      <?php } ?>
                      <button type="submit" class="btn btn-gradient-primary mb-2">Submit</button>
                    </form>
                  </div>
